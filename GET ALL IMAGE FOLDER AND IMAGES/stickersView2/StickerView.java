...
public class StickerView extends RelativeLayout {
    ...
    public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        paintCircle.setColor(getContext().getResources().getColor(R.color.colorPrimary));
    ...
    public void setShowSticker(boolean show) {
        for (int i = 0; stickers.size() > i; i++) {
            stickers.get(i).setShow(show);
        }
    }
}
